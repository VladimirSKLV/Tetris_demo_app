...
import ru.tetris.demo.GameActivity
import ru.tetris.demo.constants.CellConstants
import ru.tetris.demo.constants.FieldConstants
import ru.tetris.demo.models.AppModel
import ru.tetris.demo.models.Block
...
class TetrisView : View {
    ...
    private val viewHandler = ViewHandler(this, Looper.getMainLooper())
    ...
    private class ViewHandler(private val owner: TetrisView, looper: Looper) : Handler(looper) {
